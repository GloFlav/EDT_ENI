            ...
            <div class="modal-content">
                <form @submit.prevent="addEnseignant()">
                    <div class="modal-header">
                        <h5 class="modal-title">Ajout - Enseignant</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div>
                            ...
                            <input type="text" class="form-control" id="nom" name="nom" v-model.trim="enseignantInfo['nom_enseignant']">
                        </div>
                    </div>
...
export default {
    ...
    methods: {
        async addEnseignant() {
            createEntity('enseignant', this.enseignantInfo)
            .then(res => {
