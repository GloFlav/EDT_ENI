    ...
    <div class="modal fade" id="updateModal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <form @submit.prevent="updateHeure()">
                    <div class="modal-header">
                        <h5 class="modal-title">Modification - Heure</h5>
...
export default {
        ...
        heureInfoToUpdate: {
            handler(newVal) {
                if (JSON.stringify(newVal) !== '{}') {
                    this.heureInfo['id'] = newVal['id'];
                    this.heureInfo['debut'] = newVal['debut'];
                    this.heureInfo['fin'] = newVal['fin'];
                }
            },
            deep: true
        }
    ...
    methods: {
        async updateHeure() {
            updateEntity('heure', this.heureInfo.id, this.heureInfo)
            .then(res => {
